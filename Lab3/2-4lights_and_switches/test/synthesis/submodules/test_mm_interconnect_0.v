...
// 
// Generated using ACDS version 14.0 200 at 2016.02.09.02:12:30
...
module test_mm_interconnect_0 (
		...
		input  wire [12:0] cpu_instruction_master_address,          //            cpu_instruction_master.address
	...
	wire  [89:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_mem_s1_agent:cp_data
	...
	wire  [13:0] led_pio_s1_agent_m0_address;                                               // led_pio_s1_agent:m0_address -> led_pio_s1_translator:uav_address
	...
	wire  [89:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [13:0] switches_pio_s1_agent_m0_address;                                          // switches_pio_s1_agent:m0_address -> switches_pio_s1_translator:uav_address
	...
	wire  [90:0] switches_pio_s1_agent_rf_source_data;                                      // switches_pio_s1_agent:rf_source_data -> switches_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] switches_pio_s1_agent_rsp_fifo_out_data;                                   // switches_pio_s1_agent_rsp_fifo:out_data -> switches_pio_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> switches_pio_s1_agent:cp_data
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> switches_pio_s1_agent:cp_channel
	...
	wire  [89:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [89:0] led_pio_s1_agent_rp_data;                                                  // led_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [89:0] switches_pio_s1_agent_rp_data;                                             // switches_pio_s1_agent:rp_data -> router_006:sink_data
	...
	test_mm_interconnect_0_router_003 router_004 (
	...
	test_mm_interconnect_0_router_002 router_005 (
	...
	test_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
