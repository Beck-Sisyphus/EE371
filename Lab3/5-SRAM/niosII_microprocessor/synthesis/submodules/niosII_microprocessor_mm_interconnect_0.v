// niosII_microprocessor_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module niosII_microprocessor_mm_interconnect_0 (
		...
		output wire [1:0]  outen_s1_address,                        //                        outen_s1.address
		output wire        outen_s1_write,                          //                                .write
		input  wire [31:0] outen_s1_readdata,                       //                                .readdata
		output wire [31:0] outen_s1_writedata,                      //                                .writedata
		output wire        outen_s1_chipselect,                     //                                .chipselect
	...
	wire  [94:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> led_s1_agent:cp_data
	...
	wire  [31:0] outen_s1_agent_m0_readdata;                                                // outen_s1_translator:uav_readdata -> outen_s1_agent:m0_readdata
	wire         outen_s1_agent_m0_waitrequest;                                             // outen_s1_translator:uav_waitrequest -> outen_s1_agent:m0_waitrequest
	wire         outen_s1_agent_m0_debugaccess;                                             // outen_s1_agent:m0_debugaccess -> outen_s1_translator:uav_debugaccess
	wire  [16:0] outen_s1_agent_m0_address;                                                 // outen_s1_agent:m0_address -> outen_s1_translator:uav_address
	wire   [3:0] outen_s1_agent_m0_byteenable;                                              // outen_s1_agent:m0_byteenable -> outen_s1_translator:uav_byteenable
	wire         outen_s1_agent_m0_read;                                                    // outen_s1_agent:m0_read -> outen_s1_translator:uav_read
	wire         outen_s1_agent_m0_readdatavalid;                                           // outen_s1_translator:uav_readdatavalid -> outen_s1_agent:m0_readdatavalid
	wire         outen_s1_agent_m0_lock;                                                    // outen_s1_agent:m0_lock -> outen_s1_translator:uav_lock
	wire  [31:0] outen_s1_agent_m0_writedata;                                               // outen_s1_agent:m0_writedata -> outen_s1_translator:uav_writedata
	wire         outen_s1_agent_m0_write;                                                   // outen_s1_agent:m0_write -> outen_s1_translator:uav_write
	wire   [2:0] outen_s1_agent_m0_burstcount;                                              // outen_s1_agent:m0_burstcount -> outen_s1_translator:uav_burstcount
	wire         outen_s1_agent_rf_source_valid;                                            // outen_s1_agent:rf_source_valid -> outen_s1_agent_rsp_fifo:in_valid
	wire  [95:0] outen_s1_agent_rf_source_data;                                             // outen_s1_agent:rf_source_data -> outen_s1_agent_rsp_fifo:in_data
	wire         outen_s1_agent_rf_source_ready;                                            // outen_s1_agent_rsp_fifo:in_ready -> outen_s1_agent:rf_source_ready
	wire         outen_s1_agent_rf_source_startofpacket;                                    // outen_s1_agent:rf_source_startofpacket -> outen_s1_agent_rsp_fifo:in_startofpacket
	wire         outen_s1_agent_rf_source_endofpacket;                                      // outen_s1_agent:rf_source_endofpacket -> outen_s1_agent_rsp_fifo:in_endofpacket
	wire         outen_s1_agent_rsp_fifo_out_valid;                                         // outen_s1_agent_rsp_fifo:out_valid -> outen_s1_agent:rf_sink_valid
	wire  [95:0] outen_s1_agent_rsp_fifo_out_data;                                          // outen_s1_agent_rsp_fifo:out_data -> outen_s1_agent:rf_sink_data
	wire         outen_s1_agent_rsp_fifo_out_ready;                                         // outen_s1_agent:rf_sink_ready -> outen_s1_agent_rsp_fifo:out_ready
	wire         outen_s1_agent_rsp_fifo_out_startofpacket;                                 // outen_s1_agent_rsp_fifo:out_startofpacket -> outen_s1_agent:rf_sink_startofpacket
	wire         outen_s1_agent_rsp_fifo_out_endofpacket;                                   // outen_s1_agent_rsp_fifo:out_endofpacket -> outen_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> outen_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> outen_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // outen_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> outen_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> outen_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> outen_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> wren_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> wren_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // wren_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> wren_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> wren_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> wren_s1_agent:cp_endofpacket
	...
	wire  [16:0] address_s1_agent_m0_address;                                               // address_s1_agent:m0_address -> address_s1_translator:uav_address
	...
	wire  [95:0] address_s1_agent_rf_source_data;                                           // address_s1_agent:rf_source_data -> address_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] address_s1_agent_rsp_fifo_out_data;                                        // address_s1_agent_rsp_fifo:out_data -> address_s1_agent:rf_sink_data
	...
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> address_s1_agent:cp_valid
	wire  [94:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> address_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // address_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> address_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> address_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> address_s1_agent:cp_endofpacket
	...
	wire  [16:0] data_s1_agent_m0_address;                                                  // data_s1_agent:m0_address -> data_s1_translator:uav_address
	...
	wire  [95:0] data_s1_agent_rf_source_data;                                              // data_s1_agent:rf_source_data -> data_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] data_s1_agent_rsp_fifo_out_data;                                           // data_s1_agent_rsp_fifo:out_data -> data_s1_agent:rf_sink_data
	...
	wire         cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> data_s1_agent:cp_valid
	wire  [94:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> data_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // data_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> data_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> data_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> data_s1_agent:cp_endofpacket
	...
	wire  [94:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_007:sink_data
	...
	wire         outen_s1_agent_rp_valid;                                                   // outen_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] outen_s1_agent_rp_data;                                                    // outen_s1_agent:rp_data -> router_008:sink_data
	wire         outen_s1_agent_rp_ready;                                                   // router_008:sink_ready -> outen_s1_agent:rp_ready
	wire         outen_s1_agent_rp_startofpacket;                                           // outen_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         outen_s1_agent_rp_endofpacket;                                             // outen_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         wren_s1_agent_rp_valid;                                                    // wren_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] wren_s1_agent_rp_data;                                                     // wren_s1_agent:rp_data -> router_009:sink_data
	wire         wren_s1_agent_rp_ready;                                                    // router_009:sink_ready -> wren_s1_agent:rp_ready
	wire         wren_s1_agent_rp_startofpacket;                                            // wren_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         wren_s1_agent_rp_endofpacket;                                              // wren_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         address_s1_agent_rp_valid;                                                 // address_s1_agent:rp_valid -> router_010:sink_valid
	wire  [94:0] address_s1_agent_rp_data;                                                  // address_s1_agent:rp_data -> router_010:sink_data
	wire         address_s1_agent_rp_ready;                                                 // router_010:sink_ready -> address_s1_agent:rp_ready
	wire         address_s1_agent_rp_startofpacket;                                         // address_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         address_s1_agent_rp_endofpacket;                                           // address_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         data_s1_agent_rp_valid;                                                    // data_s1_agent:rp_valid -> router_011:sink_valid
	wire  [94:0] data_s1_agent_rp_data;                                                     // data_s1_agent:rp_data -> router_011:sink_data
	wire         data_s1_agent_rp_ready;                                                    // router_011:sink_ready -> data_s1_agent:rp_ready
	wire         data_s1_agent_rp_startofpacket;                                            // data_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         data_s1_agent_rp_endofpacket;                                              // data_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         outen_s1_agent_rdata_fifo_src_valid;                                       // outen_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] outen_s1_agent_rdata_fifo_src_data;                                        // outen_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         outen_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_006:in_0_ready -> outen_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> outen_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> outen_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // outen_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> outen_s1_agent:rdata_fifo_sink_error
	wire         wren_s1_agent_rdata_fifo_src_valid;                                        // wren_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] wren_s1_agent_rdata_fifo_src_data;                                         // wren_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         wren_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_007:in_0_ready -> wren_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> wren_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> wren_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // wren_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> wren_s1_agent:rdata_fifo_sink_error
	wire         address_s1_agent_rdata_fifo_src_valid;                                     // address_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] address_s1_agent_rdata_fifo_src_data;                                      // address_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         address_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_008:in_0_ready -> address_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> address_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> address_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // address_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> address_s1_agent:rdata_fifo_sink_error
	wire         data_s1_agent_rdata_fifo_src_valid;                                        // data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] data_s1_agent_rdata_fifo_src_data;                                         // data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         data_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_009:in_0_ready -> data_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> data_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> data_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                         // data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> data_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (outen_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (outen_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (outen_s1_agent_m0_read),                //                         .read
		.uav_write              (outen_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (outen_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (outen_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (outen_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (outen_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (outen_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (outen_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (outen_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (outen_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (outen_s1_write),                        //                         .write
		.av_readdata            (outen_s1_readdata),                     //                         .readdata
		.av_writedata           (outen_s1_writedata),                    //                         .writedata
		.av_chipselect          (outen_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (outen_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (outen_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (outen_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (outen_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (outen_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (outen_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (outen_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (outen_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (outen_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (outen_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (outen_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (outen_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (outen_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (outen_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (outen_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (outen_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (outen_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (outen_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (outen_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (outen_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (outen_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (outen_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (outen_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (outen_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (outen_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (outen_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),         //                .error
		.rdata_fifo_src_ready    (outen_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (outen_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (outen_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) outen_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (outen_s1_agent_rf_source_data),             //        in.data
		.in_valid          (outen_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (outen_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (outen_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (outen_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (outen_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (outen_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (outen_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (outen_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (outen_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	niosII_microprocessor_mm_interconnect_0_router router (
	...
	niosII_microprocessor_mm_interconnect_0_router_001 router_001 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_002 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_003 (
	...
	niosII_microprocessor_mm_interconnect_0_router_004 router_004 (
	...
	niosII_microprocessor_mm_interconnect_0_router_004 router_005 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_006 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_007 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (outen_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (outen_s1_agent_rp_valid),               //          .valid
		.sink_data          (outen_s1_agent_rp_data),                //          .data
		.sink_startofpacket (outen_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (outen_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_009 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_010 (
	...
	niosII_microprocessor_mm_interconnect_0_router_002 router_011 (
	...
	niosII_microprocessor_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosII_microprocessor_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	niosII_microprocessor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (outen_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (outen_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (outen_s1_agent_rdata_fifo_src_ready),   //         .ready
